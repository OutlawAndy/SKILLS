...
description: 'Use this skill to guide a developer or designer through a BRAVE framework
  ...
  a task before picking it up, or prepare a breakdown to share with a teammate or
  client. Also trigger for any of these phrases or close variations: "BRAVE this",
  "brave it", "break down this card", "think through this ticket", "help me plan this
  out before I start", "want to make sure I understand this before I start coding",
  "want to revalidate this card", "help me think through this before my standup/meeting",
  or "I''m about to pick up a card and want to break it down". If someone mentions
  starting work on a card and wants help planning, validating, or understanding it
  first — this skill should run.

  '
---
<!-- Generated by outlaw-skills v0.1.0. Source: src/skills/brave-breakdown/SKILL.md -->
# BRAVE Breakdown
