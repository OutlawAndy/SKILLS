...
description: Execute Rails work with mandatory dispatch to layered-rails, ce-dhh-rails-style,
  ...
  focused changes. Replaces the generic ce-work workflow for Rails-only environments.
  Triggers on phrases like "work this", "implement this", "ship this", or any direct
  request to do Rails work.
---
<!-- Generated by outlaw-skills v0.1.0. Source: src/skills/work/SKILL.md -->
