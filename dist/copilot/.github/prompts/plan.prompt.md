...
description: Create a Rails-aware implementation plan by priming pattern skills and
  ...
  environments. Triggers on phrases like "plan this", "create a plan", "write a tech
  plan", "plan the implementation", "how should we build", "what's the approach for",
  or "break this down".
---
<!-- Generated by outlaw-skills v0.1.0. Source: src/skills/plan/SKILL.md -->
