...
description: Internal Rails posture primer loaded by outlaw-skills workflow skills
  ...
  mandatory dispatch triggers, and pressure tests that orient subsequent Rails work.
  Workflow skills load this before pattern skills so they share a single Rails framing.
---
<!-- Generated by outlaw-skills v0.1.0. Source: src/skills/rails-context/SKILL.md -->
# Rails Context
