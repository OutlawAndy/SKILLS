---
description: Conditional code-review persona, selected when the diff touches Rails
  application code. Reviews Rails changes with Kieran's strict bar for clarity, conventions,
  and maintainability.
tools:
- codebase
- search
- runCommands
---
<!-- Generated by outlaw-skills v0.1.1. Source: src/agents/kieran-rails-reviewer.agent.md -->
