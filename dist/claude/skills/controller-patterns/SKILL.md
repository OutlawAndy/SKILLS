...
- Use `save` & `update` with conditionals, not `save!` or `update!` with exception handling. Exceptions are for truly exceptional circumstances, not failed validations.
